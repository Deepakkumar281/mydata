...
const TemplateList: React.FC<TemplateListProps> = ({item, user}) => {
  ...
  // console.log(fontAwesomeIcons,"fontAwesomeIcons")
          ...
          <Card.Actions style={styles.cardActions}>
            <Button>
              <Icon
                ...
                size={30}
                name={
                  isValidIconName(item?.attribute?.icon_name)
                    ? item?.attribute?.icon_name
                    : 'sticky-note-o'
                }
                color="#8600d5" // Replace with the color you want
              />
            </Button>
